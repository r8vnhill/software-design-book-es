...
\part{Por algo se empieza}
  ...
  \chapter{¡Kotlin!}
    ...
    \chapter{\textit{Git} ¿Amigo o enemigo?}
      Una de las herramientas más importantes que deben conocer es \textit{Git}\index{Git}, o algún otro 
      \textit{sistema de versionado}.
      Un \textit{sistema de versionado}