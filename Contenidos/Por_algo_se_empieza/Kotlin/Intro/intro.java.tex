\section{¿Java?}
  \textit{Java}\index{Java} es uno de los lenguajes de programación más utilizados en el mundo, se 
  ...
  funcionamiento de la \textit{Java Virtual Machine}\index{Java Virtual Machine} para entender sus 
  ...
  % \subsection{¿Debería instalar \textit{Java}?}
  %   \begin{quote}{Anita Tijoux}
  %     \enquote{Haz la w** que querai, pero ponte chaleco}
  %   \end{quote}

  %   Esto es algo completamente opcional, no es necesario para este libro, pero es uno de los 
  %   lenguajes más utilizados en el mundo y los contenidos de este libro son directamente aplicables
  %   a este lenguaje.

  %   Si por alguna razón quieren instalar \textit{Java}, puedes encontrar una guía de instalación al 
